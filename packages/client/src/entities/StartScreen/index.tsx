...
export const StartScreen = ({
    ...
    if (gameState === GAME_STATE.RUNNING || gameState === GAME_STATE.PAUSED) return null;
                        ...
                        <main className={s.content}>
                            {gameState === GAME_STATE.PREPARE && (
                                <CountdownCircleTimer
                                    ...
                                    colorsTime={[3, 2, 1, 0]}
                                    onUpdate={(remainingTime) => remainingTime === 0}
                                    onComplete={() => setGameState(GAME_STATE.RUNNING)}
                                >
